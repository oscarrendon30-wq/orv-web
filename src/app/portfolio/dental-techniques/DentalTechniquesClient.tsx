...
export default function DentalTechniquesClient() {
  const { t, language, setLanguage } = useLanguage();

  const content = {
    eyebrow: {
      es: "ODONTOLOGÍA & SALUD",
      en: "DENTISTRY & HEALTH"
    },
    desc: {
      es: "Identidad visual, papelería comercial, lista de precios y desarrollo web para una marca odontológica con presencia profesional y comunicación clara.",
      en: "Visual identity, commercial stationery, price list, and web development for a dental brand with a professional presence and clear communication."
    },
    tags: {
      es: ["Branding", "Diseño web", "Papelería comercial", "Lista de precios", "Sector odontológico"],
      en: ["Branding", "Web Design", "Commercial Stationery", "Price List", "Dental Sector"]
    },
    sheet: {
      client: { es: "Dental Techniques", en: "Dental Techniques" },
      category: { es: "Odontología & Salud", en: "Dentistry & Health" },
      services: { es: "Identidad visual, papelería, web, lista de precios", en: "Visual identity, stationery, web, price list" },
      focus: { es: "Confianza, limpieza, precisión y tecnología dental", en: "Trust, cleanliness, precision, and dental technology" },
      year: { es: "2025", en: "2025" }
    },
    summary: {
      es: "El objetivo central fue construir una presencia visual clara, confiable y profesional para una marca odontológica. Se enfatizó una comunicación visual limpia con alta legibilidad y consistencia, proyectando seguridad y cuidado hacia los pacientes.",
      en: "The main objective was to build a clear, reliable, and professional visual presence for a dental brand. Emphasis was placed on clean visual communication with high legibility and consistency, projecting safety and care to patients."
    },
    devTitle: { es: "Piezas desarrolladas", en: "Developed Pieces" },
    blocks: [
      {
        title: { es: "Identidad y Enfoque Visual", en: "Identity and Visual Focus" },
        desc: { es: "Uso de azul, blanco y tonos limpios asociados a la salud, garantizando una composición clara y jerarquía informativa pensada especialmente para pacientes.", en: "Use of blue, white, and clean tones associated with health, ensuring a clear composition and information hierarchy designed specifically for patients." }
      },
      {
        title: { es: "Lista de precios y papelería", en: "Price list and stationery" },
        desc: { es: "Diseño de materiales impresos, tarjetas y listas de precios estructurados para facilitar la lectura de los servicios odontológicos.", en: "Design of printed materials, cards, and price lists structured to facilitate the reading of dental services." }
      },
      {
    ...
    websiteBtn: { es: "Ver sitio web: dentaltechniquesftmyers.com", en: "View website: dentaltechniquesftmyers.com" },
    resultTitle: { es: "Marca profesional y ordenada", en: "Professional and organized brand" },
    result: {
      es: "El resultado es una marca odontológica mucho más profesional, ordenada y confiable, capaz de presentar sus servicios de forma clara y mantener una coherencia visual en todos sus canales impresos y digitales.",
      en: "The result is a much more professional, organized, and reliable dental brand, capable of presenting its services clearly and maintaining visual coherence across all its printed and digital channels."
    }
  };
          ...
          <div className="relative w-full max-w-5xl mx-auto">
            ...
            <div className="relative mb-12 lg:mb-16 group">
              <div className="relative flex flex-col lg:flex-row items-center gap-6 lg:gap-8 bg-white/60 backdrop-blur-md shadow-[0_15px_40px_-15px_rgba(7,27,51,0.03)] hover:shadow-[0_20px_50px_-15px_rgba(7,27,51,0.08)] rounded-[32px] p-4 lg:p-6 transition-all duration-500 overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[24px] overflow-hidden bg-[#F8FAFC] border border-[#071B33]/5 flex items-center justify-center p-1 md:p-2">
                  <ZoomableImage src="/images/portfolio/dentaltechniques/dental-logo.webp" alt="Logo e Identidad Visual" fill className="object-contain p-4 md:p-8 group-hover:scale-105 transition-transform duration-700 ease-out opacity-100" />
                </div>
            ...
            <div className="relative mb-12 lg:mb-16 group">
              <div className="relative flex flex-col lg:flex-row items-center gap-6 lg:gap-8 bg-[#F8FAFC]/50 backdrop-blur-md shadow-[0_15px_40px_-15px_rgba(7,27,51,0.03)] hover:shadow-[0_20px_50px_-15px_rgba(7,27,51,0.08)] rounded-[32px] p-4 lg:p-6 transition-all duration-500 overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[24px] overflow-hidden bg-white border border-[#071B33]/5 flex items-center justify-center p-1 md:p-2 order-1 lg:order-2">
                  <ZoomableImage src="/images/portfolio/dentaltechniques/dental-lista-precios.webp" alt="Lista de precios Dental Techniques" fill className="object-cover p-0 md:p-0 group-hover:scale-105 transition-transform duration-700 ease-out" />
                </div>
              </div>
            </div>
            ...
            <div className="relative mb-12 lg:mb-16 group">
              <div className="relative flex flex-col lg:flex-row items-center gap-6 lg:gap-8 bg-white/60 backdrop-blur-md shadow-[0_15px_40px_-15px_rgba(7,27,51,0.03)] hover:shadow-[0_20px_50px_-15px_rgba(7,27,51,0.08)] rounded-[32px] p-4 lg:p-6 transition-all duration-500 overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[24px] overflow-hidden bg-[#F8FAFC] border border-[#071B33]/5 flex items-center justify-center p-1 md:p-2">
                  <ZoomableImage src="/images/portfolio/dentaltechniques/dental-web.webp" alt="Desarrollo Web" fill className="object-cover p-0 md:p-0 group-hover:scale-105 transition-transform duration-700 ease-out opacity-90" />
                </div>
                <div className="w-full lg:w-1/2 flex flex-col justify-center px-4 lg:px-8 py-6 lg:py-8">
                  <span className="font-sans text-[#00A3FF] text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase mb-4 flex items-center gap-3">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-12 md:mb-16">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackClickWhatsApp("Project CTA - Dental Techniques")}
          ...
          <ProjectNavigation currentProject="dental-techniques" />
        </div>
      </div>
    </main>
  );
