      ...
      <div className="w-full md:w-7/12 lg:w-1/2 p-8 md:p-10 lg:p-12 flex flex-col justify-center relative">
        ...
        <div className="mt-auto pt-4 md:pt-5 border-t border-zinc-100 flex flex-col items-start">
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-4 w-full sm:w-auto">
            ...
            {service.id === "branding" ? (
            ...
            ) : service.id === "editorial" ? (
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                <Link
                  href="/servicios/diseno-editorial/"
                  onClick={() => trackCtaClick("Ver Servicio Editorial", "Services Panel")}
                  className="inline-flex items-center justify-center gap-1.5 text-sm font-semibold text-[#00A3FF] hover:text-[#008fe0] transition-colors underline underline-offset-4 decoration-[#00A3FF]/40 hover:decoration-[#00A3FF] text-center sm:text-left"
                >
                  {language === "es" ? "Conocer más del servicio" : "Learn more about service"}
                  <ArrowRight className="w-3.5 h-3.5" />
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                <Link
                  ...
                  onClick={() => trackCtaClick("Ver Servicio Diseno Web", "Services Panel")}
                  className="inline-flex items-center justify-center gap-1.5 text-sm font-semibold text-[#00A3FF] hover:text-[#008fe0] transition-colors underline underline-offset-4 decoration-[#00A3FF]/40 hover:decoration-[#00A3FF] text-center sm:text-left"
                >
                  {language === "es" ? "Conocer más del servicio" : "Learn more about service"}
                  <ArrowRight className="w-3.5 h-3.5" />
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                <Link
                  ...
                  onClick={() => trackCtaClick("Ver Servicio Empaques", "Services Panel")}
                  className="inline-flex items-center justify-center gap-1.5 text-sm font-semibold text-[#00A3FF] hover:text-[#008fe0] transition-colors underline underline-offset-4 decoration-[#00A3FF]/40 hover:decoration-[#00A3FF] text-center sm:text-left"
                >
                  {language === "es" ? "Conocer más del servicio" : "Learn more about service"}
                  <ArrowRight className="w-3.5 h-3.5" />
